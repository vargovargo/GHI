...
Obtaining the full detailed mortality needed for ITHIM requires querying CDC WONDER no less than 4 times. You can run the queries and create these files for your self at [this website](https://wonder.cdc.gov/controller/saved/D76/D7F634).  Be sure to select your state and modify the filename and query properties appropriately between each one. 
