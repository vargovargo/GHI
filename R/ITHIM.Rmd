...
```{r statewiseGBD, eval = FALSE, dev=c('pdf', 'png'), fig.width = 2*fig.width, fig.asp = 1/phi, warning = FALSE, message = FALSE, echo = FALSE}
D <- melt(lapply(ITHIMList, function(ITHIM) return(ITHIM@parameters@GBD)))

D <- do.call(rbind,lapply(ITHIMList, getGBD))
