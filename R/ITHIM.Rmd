...
RR.baseline <- lapply(RR, MET2RR, ITHIM.baseline$quintiles$TotalMET)
RR.scenario <- lapply(RR, MET2RR, ITHIM.scenario$quintiles$TotalMET)
...
```{r AF}
100*round(AF$BreastCancer[-(1:2),],4)
