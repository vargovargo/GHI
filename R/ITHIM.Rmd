...
ITHIM.national <- updateITHIM(ITHIM.national, "muNonTravel", 5)
...
p + theme_bw() + scale_x_discrete(name="", labels = c("0-4","5-14","15-29","30-44","45-59","60-69","70-79","80+")) + scale_y_continuous(name="Nationwide Burden (thousands)") + theme(axis.text.x  = element_text(angle = 90, vjust = 0.5, size = 10)) + facet_grid( type ~ disease, scales = "free_y")
```
