...
stateVec <- c("CA","TX","NY","FL","WI","MI", "OH") #c("CA","TX","NY","FL","VA","NC","AZ")
stateVecOrdered <- c("TX","FL","NY","CA","WI","MI", "OH") #c("NC","TX","VA","FL","AZ","NY","CA")
...
pedDeath <- within(pedDeath,{
  ...
  activeTract <- (pctWalkToWork + pctBikeToWork ) > 0
})
...
p <- ggplot(subset(D, variable %in% c("vehMiles","pctWalkToWork","activeTract")), aes(deathsTotalLogical, value, colour = deathsTotalLogical))
p + geom_boxplot() + facet_grid(variable ~ ., scales = "free_y")
```
