...
stateVec <- c("CA","NY","WI","MI","OH") #c("CA","TX","NY","FL","VA","NC","AZ")
...
ITHIM.default <- update(ITHIM.default, "cvNonTravel", 3)
ITHIM.default <- update(ITHIM.default, "cv", 1.65)
ITHIM.default <- update(ITHIM.default, "muNonTravel", 4)
ITHIM.default <- update(ITHIM.default, "muNonTravelMatrix", METmatrix)
ITHIM.default <- update(ITHIM.default, "quantiles", (1:99)/100)

ITHIM.national <- ITHIM.default
ITHIM.national <- update(ITHIM.national, "muwt", muwtNational)
ITHIM.national <- update(ITHIM.national, "muct", muctNational)
ITHIM.national <- update(ITHIM.national, "Rwt", RwtNational)
ITHIM.national <- update(ITHIM.national, "Rct", RctNational)

for (HHSTATE in stateVec){
    ITHIMList[[HHSTATE]] <- ITHIM.default
    ITHIMList[[HHSTATE]] <- update(ITHIMList[[HHSTATE]], "muwt", muwtList[[HHSTATE]])
    ITHIMList[[HHSTATE]] <- update(ITHIMList[[HHSTATE]], "muct", muctList[[HHSTATE]])
    ITHIMList[[HHSTATE]] <- update(ITHIMList[[HHSTATE]], "Rwt", RwtList[[HHSTATE]])
    ITHIMList[[HHSTATE]] <- update(ITHIMList[[HHSTATE]], "Rct", RctList[[HHSTATE]])
    ITHIMList[[HHSTATE]] <- update(ITHIMList[[HHSTATE]], "GBD", gbdList[[HHSTATE]])
  }
...
for( muNonTravel in seq(0, upper, by = wd)){
  ...
  for (HHSTATE in stateVec){
    ITHIMList[[HHSTATE]] <- update(ITHIMList[[HHSTATE]], "muNonTravel", muNonTravel)
  }

  ITHIM.national <- update(ITHIM.national, "muNonTravel", muNonTravel)
...
ITHIMListScenario <- lapply(ITHIMList, function(ithim) update(ithim, parName = "muwt", parValue = ithim@parameters@muwt + 10*7))
...
ITHIM.national <- update(ITHIM.national, parName = "muNonTravel", 10)

#~~~~~~~~~~

ITHIM.CA <- ITHIMList[["CA"]]
ITHIM.CA <- update(ITHIM.CA, parName = "muNonTravel", 10)
...
ITHIM.NY <- update(ITHIM.NY, parName = "muNonTravel", 10)
...
ITHIM.national.quints <- update(ITHIM.national, "quantiles", seq(1,9,by=1)/10)
ITHIM.scenario.quints <- update(ITHIM.scenario, "quantiles", seq(1,9,by=1)/10)
...
for(at in atVec ){  # minutes active transport/week
  for( muNonTravel in muNonTravelVec ){
    ...
    ITHIM.scenario <- update(ITHIM.scenario, "muwt", at*pWalk)
    ITHIM.scenario <- update(ITHIM.scenario, "muct", at*(1-pWalk))
    ITHIM.scenario <- update(ITHIM.scenario, "muNonTravel", muNonTravel)

    ITHIM.scenario.quints <- update(ITHIM.scenario.quints, "muwt", at*pWalk)
    ITHIM.scenario.quints <- update(ITHIM.scenario.quints, "muct", at*(1-pWalk))
    ITHIM.scenario.quints <- update(ITHIM.scenario.quints, "muNonTravel", muNonTravel)
...
ITHIM.national <- update(ITHIM.national, "muNonTravel", 10)
