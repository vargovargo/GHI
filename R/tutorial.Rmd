...
Currently the list of parameters resides in the help page for
"createParameterList".  We will find a better place for it.
Alternatively one can inspect the slots directly with slotNames.

```{r misc24, message = FALSE, eval = TRUE, warning = FALSE, error = TRUE, echo = TRUE}
...
deltaBurden(ITHIM.baseline, ITHIM.scenario, dis = "total", bur = "daly.delta")
```
