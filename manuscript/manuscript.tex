...
\textit{ Here $R(x)$ represents the risk when the individual has
  exposure $x$, in our case physical activity (\mets).  $P(x)$ and
  $Q(x)$ denote the population density of individuals with exposure
  $x$, in the baseline and alternate scenarios, respectively.  The
  exposure variable, $x$, is modeled as the sum of travel-related
  exposure and non-travel-related exposure.}
