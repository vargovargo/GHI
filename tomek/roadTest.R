...
ITHIM.scenario <- update(ITHIM.baseline, list(distRoadType = readDistByRoadType(system.file("distByRoadTypeScenario.csv", package = "ITHIM"))))

# RoadInjuries for baseline

ITHIM.baseline <- update(ITHIM.baseline, list(roadInjuries = readRoadInjuries(system.file("roadInjuriesBaseline.csv", package = "ITHIM"))))
