...
\begin{flushleft}
{\Large
\textbf\newline{Improved Implementation of Comparative Risk
  Assessment for Health Benefits of Active Transportation Using
  National Datasets} % Please use "title case" (capitalize all terms in the title except conjunctions, prepositions, and articles).
}
\newline
% Insert author names, affiliations and corresponding author email (do not include titles, positions, or degrees).
\\
Samuel Younkin\textsuperscript{1},\ %,2\Yinyang},
Jason Vargo\textsuperscript{1},\ %\Yinyang},
Jonathan Patz\textsuperscript{1}%,3\textcurrency},
...
\input{tex/materialsAndMethods}

\section*{Results}
\begin{figure}[t]
    \centerline{\includegraphics[width=\textwidth]{./figures/fig2}}
...
\begin{figure}[t]
  \centerline{\includegraphics[width=\textwidth]{./figures/fig4.pdf}}
...
\input{tex/supportingInformation}
